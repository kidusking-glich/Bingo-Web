...
import { ArrowLeft, Play, Coins, Trophy, Users, ShieldAlert, Sparkles, RefreshCw } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-6 mt-8 w-full flex-grow space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 border-b border-purple-500/10 pb-6">
          <div className="space-y-1">
            ...
            <p className="text-zinc-400 text-xs font-semibold">Pick a room matching your style and budget. Tournament rooms have higher rewards.</p>
          </div>
          <button
              ...
              return (
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-2 bg-zinc-950/50 border border-white/5 p-3 rounded-2xl">
                      ...
                      <div className="text-center border-x border-white/5">
                        <span className="text-[8px] text-zinc-500 uppercase font-black tracking-wider block">Prize Pool</span>
                        <span className="text-xs font-black text-fuchsia-400 block mt-1 flex items-center justify-center gap-1">
                          ...
                          ${parseFloat(room.prizePool).toFixed(2)}
                        </span>
                      </div>
                      <div className="text-center">
                  ...
                  <div className="flex items-center justify-between gap-4 pt-2">
                    ...
                    <Link
                      href={`/play/${room.id}`}
                      className="px-6 py-3 rounded-2xl bg-gradient-to-r from-cyan-500 to-purple-600 text-black font-black text-xs tracking-wider uppercase shadow-[0_0_10px_rgba(6,182,212,0.2)] hover:scale-102 hover:shadow-[0_0_15px_rgba(6,182,212,0.3)] transition-all duration-300"
                    >
                      Enter Room
                    </Link>
                  </div>
