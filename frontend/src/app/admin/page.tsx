...
import { ShieldAlert, Settings, DollarSign, Users, Activity, Check, X, RefreshCw, Slash, Lock, ShieldCheck, Dices } from 'lucide-react';
...
export default function AdminPanelPage() {
  ...
  const [activeTab, setActiveTab] = useState<'settings' | 'finances' | 'users' | 'analytics' | 'keno'>('settings');
              ...
              <form onSubmit={handleSaveSettings} className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="glass-panel p-6 rounded-3xl border border-white/5 space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[9px] text-zinc-500 uppercase tracking-widest font-black">Keno Max Spots</label>
                      <input
                        type="number"
                        min="1"
                        max="15"
                        required
                        value={settings.keno_max_spots}
                        onChange={(e) => setSettings({ ...settings, keno_max_spots: e.target.value })}
                        className="w-full px-4 py-3 bg-zinc-950 border border-white/5 rounded-2xl text-sm outline-none text-zinc-200"
                      />
                    </div>

                    <div className="space-y-1.5">
                      <label className="text-[9px] text-zinc-500 uppercase tracking-widest font-black">Keno Draw Size</label>
                      <input
                        type="number"
                        min="5"
                        max="40"
                        required
                        value={settings.keno_draw_size}
                        onChange={(e) => setSettings({ ...settings, keno_draw_size: e.target.value })}
                        className="w-full px-4 py-3 bg-zinc-950 border border-white/5 rounded-2xl text-sm outline-none text-zinc-200"
                      />
                    </div>
                  </div>
